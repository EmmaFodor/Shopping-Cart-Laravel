...
<table id="cart" class="table table-hover table-condensed">
 ...
 <td data-th="Product">
 <div class="row">
 <div class="col-sm-3 hidden-xs"><img src="<?php echo e($details['image']); ?>" width="30px" height="30px" class="img-responsive"/></div>
 <div class="col-sm-9">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\magazincurs\resources\views/cart.blade.php ENDPATH**/ ?>